<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="创建时间" prop="dtCreate">
        <el-date-picker clearable
          v-model="queryParams.dtCreate"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="请选择创建时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="最后更新时间" prop="dtUpdate">
        <el-date-picker clearable
    ...
    <el-table v-loading="loading" :data="deviceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="最后更新时间" align="center" prop="dtUpdate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.dtUpdate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <!-- <el-table-column label="累计编号" align="center" prop="aggregateValue" /> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="累计编号" prop="aggregateValue">
          <el-input v-model="form.aggregateValue" placeholder="请输入累计编号" />
        </el-form-item>
      </el-form>
